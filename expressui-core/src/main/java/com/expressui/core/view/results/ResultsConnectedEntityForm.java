...
public class ResultsConnectedEntityForm<T> extends CustomComponent {
    ...
    private HorizontalLayout createNavigationFormLayout() {
        ...
        previousButton.setDescription(entityForm.getUiMessageSource().getMessage("entityForm.previous.description"));
        ...
        nextButton.setDescription(entityForm.getUiMessageSource().getMessage("entityForm.next.description"));
