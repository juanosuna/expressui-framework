 ...
 */
public abstract class GridForm<T> extends EntityComponent<T> {

    @Resource
    private DefaultFormats defaultFormat;

    @Resource
    protected LabelRegistry labelRegistry;
    ...
    public void postConstruct() {
        ...
        labelRegistry.registerLabels(getFormFields());
    }
    ...
    protected Component animate(Component component, boolean useVerticalLayout) {
        ...
        toggleFormVisibilityButton.setDescription(uiMessageSource.getMessage("page.toggleSearchForm.description"));
    ...
    private class ConfigurableForm extends Form {
        ...
        protected void attachField(Object propertyId, Field field) {
            ...
            if (formFields.containsPropertyId(currentTabName, propertyId.toString())) {
                if (GridForm.this instanceof SearchForm
